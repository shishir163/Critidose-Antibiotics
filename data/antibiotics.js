...
{n:'Imipenem-cilastatin', al:'Tienam Primaxin', c:'carbapenem',
 ...
 bands:[[999,'500 mg IV q6h','ok'],[89,'400 mg IV q6h','adj'],[59,'300 mg IV q6h','adj'],[29,'200 mg IV q6h','adj'],[14,'Avoid unless dialysis starts within 48h','avoid']],
...
{n:'Flucloxacillin', al:'Floxapen Cloxacillin', c:'penicillin',
 ...
 tg:[],
 bands:[[999,'2 g IV q4–6h','ok'],[10,'1 g IV q8–12h — the PI maximum in renal failure','adj']],
...
{n:'Ampicillin', al:'Ampicilin', c:'penicillin',
 ...
 tg:['cns','pregsafe'],
 bands:[[999,'2 g IV q4–6h','ok'],[50,'2 g IV q6–8h','adj'],[29,'2 g IV q8–12h','adj'],[10,'2 g IV q24h','adj']],
...
{n:'Benzylpenicillin', al:'Penicillin G Crystalline penicillin', c:'penicillin',
 ...
 bands:[[999,'2.4 g (4 MU) IV q4–6h','ok'],[20,'Up to 2.4 g IV q6h','adj'],[10,'Up to 1.2 g IV q6h','adj']],
...
{n:'Ceftazidime', al:'Fortum Ceftum-IV Tazid', c:'cephalosporin',
 tag:'Pseudomonas',
 tg:['pseudo','cns'],
 bands:[[999,'2 g IV q8h','ok'],[50,'2 g IV q12h','adj'],[30,'2 g IV q24h','adj'],[15,'1 g IV x1, then 500 mg IV q24h','adj'],[5,'1 g IV x1, then 500 mg IV q48h','adj']],
...
{n:'Aztreonam-avibactam', al:'Emblaveo Azactam-avibactam ATM-AVI', c:'other',
 tag:'NDM and other metallo-beta-lactamase producers',
 tg:['cro','esbl','pseudo'],
 load:'2 g/0.67 g IV over 3 hours', loadwhy:'A single load, then maintenance from the next interval. The load is reduced only below CrCl 30.',
 bands:[[999,'1.5 g/0.5 g IV q6h over 3 hours','ok'],[50,'0.75 g/0.25 g IV q6h over 3 hours','adj'],[30,'0.675 g/0.225 g IV q8h over 3 hours (load 1.35 g/0.45 g)','adj'],[15,'0.675 g/0.225 g IV q12h over 3 hours (load 1 g/0.33 g)','adj']],
 ihd:'0.675 g/0.225 g q12h, given after the session — both components are dialysed',
 crrt:'Dose as for the measured clearance; discuss with pharmacy',
 hep:'No change',
 notes:['This is the drug that covers NDM and the other metallo-enzymes, which ceftazidime-avibactam does not. Avibactam protects aztreonam from the co-produced ESBL and AmpC that would otherwise destroy it.','Every dose runs over 3 hours.','Add metronidazole when anaerobes are in the picture — it has no anaerobic cover.','Do not use below CrCl 15 unless dialysis or another form of renal replacement is starting.','Where this product is not stocked, ceftazidime-avibactam plus aztreonam given together is the recognised substitute.']},
...
{n:'Teicoplanin', al:'Targocid Teiconel', c:'mrsa',
 ...
 bands:[[999,'6 mg/kg q24h','ok'],[60,'6 mg/kg q48h (or half dose daily)','adj'],[40,'6 mg/kg q72h (or a third of the dose daily)','adj']],
...
{n:'Amikacin', al:'Amikin Mikacin', c:'aminoglycoside',
 ...
 tg:['pseudo','nephro'],
 wt:true,
 bands:[[999,'15–20 mg/kg q24h','ok'],[60,'10–15 mg/kg q24–36h','adj'],[40,'7.5–10 mg/kg q36–48h','adj'],[20,'Single dose, then redose on the level','care']],
...
{n:'Ciprofloxacin', al:'Ciprocin Ciproxin Cipro', c:'quinolone',
 ...
 bands:[[999,'400 mg IV q8h','ok'],[30,'400 mg IV q12h','adj'],[10,'400 mg IV q24h','adj']],
...
{n:'Micafungin', al:'Mycamine', c:'antifungal',
 ...
 ihd:'No change', crrt:'No change',
 hep:'No change — the FDA label reports no adjustment needed even in severe impairment',
 notes:['No renal adjustment (even below CrCl 30) and no loading dose needed.','Fewer interactions than caspofungin.']},
...
{n:'Fosfomycin IV', al:'Fosmicin Monurol', c:'other',
 ...
 hep:'No change',
 notes:['Large sodium load — roughly 14 mmol of sodium per gram. In heart failure or cerebral oedema that adds up fast.','Hypokalaemia is common; replace it.','A partner drug, not a solo agent — resistance appears quickly.','The IV formulation and its renal ladder genuinely differ by country — European fosfomycin disodium is usually dosed as it is here, while the US-approved product (Contepo) is a flat 6 g q8h regardless of the indication, with its own separate renal adjustment. Check the insert of the specific product in your pharmacy before trusting this ladder.']}
