...
ব্রাউজারের ডেটা মুছে ফেললে সব যাবে। তাই **My entries → Backup** থেকে মাসে একবার
একটা ফাইল নামিয়ে রাখবেন।

**ফোন আর ডেস্কটপ মেলানো** — ফোনে Backup নামাবেন, ফাইলটা ডেস্কটপে নিয়ে
(WhatsApp/Drive/email যেভাবে সুবিধা) **Open a backup file** দিয়ে খুলবেন।
দুটো অপশন আসবে:

- **Merge** — দুই ডিভাইসের সব নোট থাকবে; একই নামে দুটো থাকলে ফাইলেরটা বসবে
- **Replace** — এই ডিভাইসের সব মুছে ফাইলেরটা বসবে

একই ফাইল দুবার খুললেও ডুপ্লিকেট হয় না। ব্যাকআপে থাকে: নোট, নিজের যোগ করা
ওষুধ-protocol, সেভ করা dilution, আর আপনার stock তালিকা।
